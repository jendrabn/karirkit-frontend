...
const faqs = [
  {
    ...
    answer:
      "KarirKit adalah platform untuk mengelola proses mencari kerja dalam satu tempat. Di dalamnya ada Pelacak Lamaran, Surat Lamaran, Pembuat CV, Portofolio Digital, Dokumen, dan Langganan.",
  },
  {
    question: "Fitur apa saja yang tersedia di KarirKit?",
    answer:
      "Fitur utamanya meliputi pelacakan lamaran, pembuatan surat lamaran, Pembuat CV, portofolio digital, pengelolaan dokumen, dan paket langganan untuk membuka akses tambahan sesuai kebutuhan.",
  },
  {
  ...
  {
    question: "Apakah Pembuat CV dan Surat Lamaran mendukung Bahasa Indonesia dan Inggris?",
    answer:
      "Ya. Pembuat CV dan Surat Lamaran mendukung Bahasa Indonesia dan Bahasa Inggris, termasuk pilihan template premium yang bisa dibuka melalui paket langganan.",
  },
  {
  ...
  {
    question: "Bagaimana cara membagikan Portofolio Digital?",
    answer:
