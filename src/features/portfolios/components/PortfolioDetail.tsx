...
import { SOCIAL_PLATFORM_LABELS, type SocialLink } from "@/types/social";
...
export function PortfolioDetail({
  ...
  return (
    <div className={className ? `container mx-auto px-4 ${className}` : "container mx-auto px-4"}>
      {backHref && (
        <div className="mb-6">
          <Link
            to={backHref}
          ...
          {user && (
            <Card>
              ...
              <CardContent>
                {user.username ? (
                  <Link
                    to={paths.publicPortfolio.list.getHref(user.username)}
                ...
                {user.username && (
                  <Button variant="outline" className="w-full mt-4" asChild>
                    <Link to={paths.publicPortfolio.list.getHref(user.username)}>
