...
import { type ColumnVisibility } from "./job-role-column-toggle";
...
interface JobRolesListProps {
  ...
  sortField: "created_at" | "updated_at" | "name" | "job_count";
  sortOrder: "asc" | "desc";
  onSort: (field: "created_at" | "updated_at" | "name" | "job_count") => void;
